...
def results(strengthTT,modeTT,strengthST,modeST):
    st.write('According to the calculations is the maximum pull-out strength of the joint', "**"+strengthTT+"**" ,' and will fail due to ', "**"+modeTT+"**")
    st.write('When conducting a shear lap test, it is possible the joint will have a maximum strength of around ', "**"+strengthST+"**", ' with',"**"+modeST+"**",'as the dominant failure mode.')
